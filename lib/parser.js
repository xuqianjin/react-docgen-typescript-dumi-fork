...
var Parser = /** @class */ (function () {
        ...
        if (propType.isUnion()) {
            if (this.shouldExtractValuesFromUnion ||
                ...
                return {
                    name: 'enum',
                    raw: propTypeString,
                    value: propType.types.map(function (type) {
                        return ({
    ...
    Parser.prototype.getPropsInfo = function (propsObj, defaultProps) {
        ...
        propertiesOfProps.forEach(function (prop) {
            ...
            result[propName] = __assign({
                defaultValue: defaultValue, description: description, name: propName, parent: parent, declarations: parents, required: required,
                type: type
            }, propTags);
        });
        return result;
    ...
    Parser.prototype.getFunctionStatement = function (statement) {
        ...
        if (ts.isVariableStatement(statement)) {
            ...
            while(initializer && ts.isCallExpression(initializer)){
                initializer = initializer.arguments[0];
            }
